...
const DanhGia = () => {
  ...
  return (
    <>
      ...
      <button className={styles.addButton} onClick={handleOpenAddModal}>Thêm Đánh Giá</button>
          ...
          <div className={styles.modalContent}>
            ...
            <form onSubmit={handleAddRating}>
              ...
              <div className={styles.formGroup}>
                ...
                <button type="button" onClick={handleCloseAddModal}>Hủy</button>
              </div>
            </form>
          </div>
        </div>
