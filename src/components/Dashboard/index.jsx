    ...
    const fetchCounts = async () => {
      try {
        const [bookRes, userRes] = await Promise.all([
          fetch('http://localhost:8181/api/sach/'),
          fetch('http://localhost:8181/api/nguoidung/')
        ]);
    ...
    <>
      <section className={styles.sidebar}>
        ...
        <ul className={`${styles.menu} ${styles.top}`}>
          ...
          <li >
            <Link to="/nguoidung">
              <i className={styles.bx}><FaUsers /></i>
              <span className={styles.text}>Người dùng</span>
            </Link>
          </li>
          <li >
            <Link to="/tacgia">
              <i className={styles.bx}><PiUserListFill /></i>
      ...
      <section className={`${styles.content} ${!sidebarOpen ? styles.hide : ''}`}>
        <nav>
          <i className={`${styles.bx} ${styles.menuIcon}`} onClick={toggleSidebar}><FaAlignJustify /></i>
          <form action="#">
        ...
        <main>
          <div className={styles.headtitle}>
            ...
            <ul className={styles.boxinfo}>
              <li>
                <i className={styles.bx}><FaBook /></i>
              ...
              <li>
                <i className={styles.bx}><GiMoneyStack /></i>
                <span className={styles.text}>
                  <h3>$2543</h3>
                  <p>Doanh Thu</p>
                </span>
