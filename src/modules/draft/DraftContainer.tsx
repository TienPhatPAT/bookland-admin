  ...
  return (
    <Routes>
      <Route element={<DraftLayout />}>
        <Route index element={<DraftTypography />} />
        <Route path={DRAFT_ROUTES.typo.path} element={<DraftTypography />} />
        <Route path={DRAFT_ROUTES.button.path} element={<DraftButton />} />
        <Route path={DRAFT_ROUTES.formControl.path} element={<DraftFormControl />} />
        <Route path={DRAFT_ROUTES.component.path} element={<DraftComponents />} />
        <Route path={DRAFT_ROUTES.iconGallery.path} element={<DraftIcon />} />
        <Route path={DRAFT_ROUTES.imageGallery.path} element={<DraftImage />} />
      </Route>
    </Routes>
  );
};
